...
declare module 'astro:transitions' {
	type TransitionModule = typeof import('astro/transitions');
...
declare module 'astro:transitions/client' {
	type TransitionRouterModule = typeof import('astro/transitions/router');
	...
	export type Options = import('astro/transitions/router').Options;
}
...
declare module 'astro:i18n' {
	export type GetLocaleOptions = import('astro/i18n').GetLocaleOptions;
